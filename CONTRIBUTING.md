...
2. See the **Building** section in [README](README.md) for setup instructions.
3. Open a pull request with a clear description and attach a short recording/GIF of the change.

## Reporting Issues

Please report bugs and request support by opening a GitHub issue or contacting the maintainer directly.
...
<details>
<summary>Legal details</summary>

The legal clauses below are directly based on the [Apache Software Foundation Individual Contributor License Agreement (ICLA)](https://www.apache.org/licenses/icla.pdf), which is widely used as a template across open-source projects.
